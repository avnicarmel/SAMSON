...
namespace SistemaSolar
{
    ...
    public class SolarSystem
    {
        ...
        public void CreateScene()
        {
            ...
            planetas.Add(new Planet(1, Planets.Earth, new Position(15, 0, 0), "tierra.jpg", true));         //create the earth
            ...
            estrella.CreateStars(3000);
            sol.Create(); //create the sun
            foreach (var item in planetas)
            {
                item.Create();  //creates the item
            }
        }
        ...
        {  
            ...
            estrella.Draw();        //stars
            sol.Paint();            //sun
            foreach (var item in planetas)      //planets
            {
               item.Paint();  //painting each created item
            }
        }
    }
}
